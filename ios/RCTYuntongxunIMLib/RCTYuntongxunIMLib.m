//
//  RCTYuntongxunIMLib.m
//  RCTYuntongxunIMLib

#import "RCTYuntongxunIMLib.h"

@implementation RCTYuntongxunIMLib
@synthesize bridge = _bridge;

RCT_EXPORT_MODULE(YuntongxunIMLibModule)
...
-(void)onReceived:(RCMessage *)message
    ...
    NSLog(@"onYuntongxunMessageReceived");
    ...
    [self sendEvent:@"onYuntongxunMessageReceived" body:body];
}
